...
class DisplayMessage extends React.Component {
    constructor(props) {
        ...
        this.prevMessTimeStamp = this.props.messagesHistory[this.props.contactIndex].data[this.props.id + 1] !== undefined ? this.props.messagesHistory[this.props.contactIndex].data[this.props.id + 1].timeStamp : null
    ...
    /*     componentWillMount = () => {
            ...
            const prevMessType = this.props.messagesHistory[this.props.contactIndex].data[this.props.id - 1] !== undefined ? this.props.messagesHistory[this.props.contactIndex].data[this.props.id - 1].type : null
            const nextMessType = this.props.messagesHistory[this.props.contactIndex].data[this.props.id + 1] !== undefined ? this.props.messagesHistory[this.props.contactIndex].data[this.props.id + 1].type : null
            const senderSame = this.isTypeSame(this.props.message.type, prevMessType)
    ...
    /*     isTypeSame = (currentMessageType, prevMessageType) => {
            return currentMessageType === prevMessageType;
        } */

    /*     _renderImage = () => {
            // if last message is the same type: doesn't display image
            if (!this.state.typeSame) {
                let uri = null
